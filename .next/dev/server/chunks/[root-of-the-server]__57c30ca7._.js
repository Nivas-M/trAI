...
const JOURNEYS = [
    ...
    },
    {
        ...
        fromCode: "MS",
        toStation: "Yesvantpur Junction",
        toCode: "YPR",
        train: "Lalbagh Express",
        departure: "22:15",
        arrival: "05:30",
        durationHours: 7.25,
        price: 420,
    ...
    },
    {
        ...
        fromStation: "Chennai Central",
        fromCode: "MAS",
        toStation: "Secunderabad Junction",
        toCode: "SC",
    ...
    },
    {
        ...
        fromCode: "SBC",
        toStation: "Ernakulam Junction",
        toCode: "ERS",
        train: "Kochuveli Express",
        departure: "20:30",
        arrival: "07:15",
        durationHours: 10.75,
        price: 480,
    ...
    },
    {
        ...
        from: "Bangalore",
        to: "Kochi",
        fromStation: "Yesvantpur Junction",
        fromCode: "YPR",
        toStation: "Ernakulam Town",
        toCode: "ERN",
        train: "Garib Rath",
        departure: "22:00",
        arrival: "07:45",
    ...
    },
    {
        ...
        from: "Delhi",
        to: "Jaipur",
        fromStation: "Delhi Sarai Rohilla",
        fromCode: "DEE",
        toStation: "Jaipur Junction",
        toCode: "JP",
        train: "Ajmer Shatabdi",
        departure: "17:40",
        arrival: "22:05",
        durationHours: 4.4,
        price: 690,
    ...
    },
    {
        ...
        from: "Delhi",
        to: "Jaipur",
        fromStation: "Old Delhi Junction",
        fromCode: "DLI",
        toStation: "Jaipur Junction",
        toCode: "JP",
    ...
    },
    {
        ...
        fromStation: "New Delhi",
        fromCode: "NDLS",
        toStation: "Chhatrapati Shivaji Terminus",
        toCode: "CSMT",
    ...
    },
    {
        ...
        from: "Delhi",
        to: "Lucknow",
        fromStation: "Anand Vihar Terminal",
        fromCode: "ANVT",
        toStation: "Lucknow Charbagh",
        toCode: "LKO",
        train: "Lucknow Mail",
        departure: "22:30",
        arrival: "06:45",
    ...
    },
    {
        ...
        from: "Mumbai",
        to: "Pune",
        fromStation: "Chhatrapati Shivaji Terminus",
        fromCode: "CSMT",
    ...
    },
    {
        ...
        from: "Kolkata",
        to: "Bhubaneswar",
        fromStation: "Santragachi Junction",
        fromCode: "SRC",
        toStation: "Bhubaneswar",
        toCode: "BBS",
        train: "Dhuli Express",
...
async function POST(request) {
    try {
        ...
        const routes = [
            ...new Set(JOURNEYS.map((j)=>`${j.from} to ${j.to}`))
        ].join(", ");
        const trainList = JOURNEYS.map((j, idx)=>`${idx + 1}. ${j.train} [${j.from} to ${j.to}]: Boards at ${j.fromStation} (${j.fromCode}), arrives at ${j.toStation} (${j.toCode}), departs ${j.departure}, arrives ${j.arrival}, takes ${j.durationHours} hours, costs Rs.${j.price}, ${j.comfort} class, reliability: ${j.reliability}`).join('\n');
...
`;
        ...
        try {
            ...
            if (Array.isArray(aiResult) && aiResult.length > 0) {
                ...
                const reorderedResults = aiResult.map((aiItem)=>JOURNEYS.find((j)=>j.train === aiItem.train)).filter(Boolean);
                return new Response(JSON.stringify({
